...
public class RightClick {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement RightB;
		// Identification
		RightB = navigateur.findElement(By.id("rightClickBtn"));
		// Action
		Actions action = new Actions(navigateur);
		action.contextClick(RightB).perform();
		// Resultat
		String resultat_attendu = "You have done a right click";
		String resultat_obtenu;
		WebElement message = navigateur.findElement(By.id("rightClickMessage"));
